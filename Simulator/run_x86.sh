...
#
# Usage: ./run_x86.sh <TRACE> [GUEST_PT] [HOST_PT]
#
...
# Examples:
#   ./run_x86.sh example
#   ./run_x86.sh ../Data/redis ../Data/redis/pt_dump ../Data/redis/pt_dump_redis_aug
#
# Outputs (Data/ holds only simulator inputs; results go to Results/):
#   Results/<name>/sim_x86.log       full simulator log (also streams to terminal)
...
# Override the output directory with OUT_DIR=/path ./run_x86.sh ...
...
mkdir -p "$OUT_DIR"
OUTPUT_FILE="$OUT_DIR/sim_x86.log"
ANALYSIS_FILE="$OUT_DIR/analysis_x86.txt"
